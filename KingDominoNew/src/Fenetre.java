...
public class Fenetre extends JFrame {
    ...
    public void creerFenetre() {
        ...
        ImageIcon imgNull =new ImageIcon( "img/fond3.png");

        this.imageMenu = new MenuG(resizePicture(imageIcon, 800,850).getImage());
        JLabel image = new JLabel(resizePicture(imgNull, 800,850));

        this.imagePlateau = new PlateauGraphic();
    ...
    public void setClavier(Clavier clavier){
        ...
        imagePlateau.addKeyListener(clavier);
    }

    public void setControlButton(ControlButton cb){
        ((MenuG)this.imageMenu).getButton().addActionListener(cb);
    }
    public void update(){
    }
